...
- **Next** — interprocedural taint now spans all eight languages; next is cross-module taint + LLM01 (untrusted-input→prompt) for the tree-sitter languages (parity with Python); GitHub Marketplace listing; PDF export from the HTML report.
